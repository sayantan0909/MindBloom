...
export default function DashboardLayout({
  ...
  const dockItems = [
    {
      title: 'Dashboard',
      icon: <Home className="w-full h-full text-indigo-600" />,
      href: '/dashboard',
    },
    {
      title: 'Expression Analysis',
      icon: <Smile className="w-full h-full text-purple-600" />,
      href: '/dashboard/expression-analysis',
    },
    {
      title: 'Screening Test',
      icon: <ClipboardList className="w-full h-full text-pink-600" />,
      href: '/dashboard/screening',
    },
    {
      title: 'Relax & Reset',
      icon: <Wind className="w-full h-full text-cyan-600" />,
      href: '/dashboard/relax',
    },
    {
      title: 'Resource Hub',
      icon: <BookOpen className="w-full h-full text-amber-600" />,
      href: '/dashboard/resources',
    },
    {
      title: 'AI Chatbot',
      icon: <Sparkles className="w-full h-full text-violet-600" />,
      href: '/dashboard/chatbot',
    },
    {
      title: 'Peer Support',
      icon: <MessageCircle className="w-full h-full text-blue-600" />,
      href: '/dashboard/peer-support',
    },
    {
      title: 'Counsellor Booking',
      icon: <Calendar className="w-full h-full text-emerald-600" />,
      href: '/dashboard/booking',
    },
    {
      title: 'Settings',
      icon: <Settings className="w-full h-full text-slate-600" />,
  ...
  return (
    <div className="relative flex min-h-screen w-full overflow-hidden font-sans bg-gradient-to-br from-indigo-50/30 via-purple-50/30 to-pink-50/30">
      ...
      {/* MAIN CONTENT AREA */}
      <div className="flex flex-col min-h-screen w-full pl-20 md:pl-24">
        {/* HEADER */}
        <header className="sticky top-0 z-40 h-16 px-6 flex items-center backdrop-blur-xl bg-white/60 border-b border-indigo-100/50">
          ...
          <Button
            variant="ghost"
            size="icon"
            className="rounded-2xl hover:bg-indigo-50"
          >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="h-11 w-11 rounded-2xl p-0 hover:bg-indigo-50"
              >
